"""Amortized IRT (1PL/Rasch, sentence-encoder) submission for the Predictive AI Evaluation Challenge."""
...
_ckpt = torch.load(
    os.path.join(_dir, "amortized_irt_rasch.pt"),
    weights_only=True,
    map_location="cpu",
)
...
print(f"AmortizedIRT (Rasch) loaded: {_ckpt['n_subjects']} subjects, {_ckpt['n_items']} items, encoder={_ckpt['encoder_name']}")
