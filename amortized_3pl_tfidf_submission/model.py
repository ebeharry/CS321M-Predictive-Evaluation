"""Amortized IRT (3PL, TF-IDF) submission for the Predictive AI Evaluation Challenge."""
...
_ckpt = torch.load(
    os.path.join(_dir, "amortized_3pl_tfidf.pt"),
    weights_only=True,
    map_location="cpu",
)
...
print(f"AmortizedIRT (3PL, TF-IDF) loaded: {_ckpt['n_subjects']} subjects, {_ckpt['n_items']} items")
