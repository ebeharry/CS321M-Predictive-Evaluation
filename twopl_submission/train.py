"""Train a 2PL IRT model and save weights to twopl.pt.

Adapted from the torch_measure tutorials.
Run from twopl_submission/:  python train.py
"""
...
save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "twopl.pt")
torch.save(
    {
        "ability": est_ability,
