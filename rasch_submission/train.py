"""Train a Rasch (1PL) IRT model and save weights to rasch.pt.

Adapted from the torch_measure tutorials.
Run from rasch_submission/:  python train.py
"""
...
save_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "rasch.pt")
torch.save(
    {
        "ability": est_ability,
